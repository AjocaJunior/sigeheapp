      ...
      {eventos.map((item) => (
        <div className="eventoItem" key={item._id}>
          ...
          <div className="itemDescricao">
            ...
            <h4 className="eventoDesc">
       {item.descricao}
            </h4>
            <span className="eventoData">Data: {item.data1} {item.data2 ?  <i>a</i>: <i> </i>} {item.data2}</span>
            <span className="eventoPeriodo">Periodo: {item.hora1} {item.hora2 ?  <i>até</i>: <i> </i>} {item.hora2}</span>
            <span className="eventoSala">Bloco: {item.bloco} - Sala: {item.sala}</span>
